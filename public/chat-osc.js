...
datachannel.onmessage = (message, userId) => addMessage(message, userId);
...
// hook up the DataChannel.js events for successfully connecting via
// WebRTC, and for receiving messages over WebRTC:
